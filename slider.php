		...
		<section id="slider" class="slider-element slider-parallax swiper_wrapper min-vh-60 min-vh-md-100 include-header" data-loop="true">
			...
			<div class="slider-inner">
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark">
							...
							<div class="swiper-slide-bg" style="background-image: url('<?php echo get_template_directory_uri( ); ?>/business/images/slider/1.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
							...
							<div class="swiper-slide-bg" style="background-image: url('<?php echo get_template_directory_uri( ); ?>/business/images/slider/2.jpg');"></div>
						</div>
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
							...
							<div class="swiper-slide-bg" style="background-image: url('<?php echo get_template_directory_uri( ); ?>/business/images/slider/3.jpg');"></div>
						</div>
					</div>
					<!-- Slider Arrows
					============================================= -->
				...
				<!-- Slider Mouse Icon
				============================================= -->
				<a href="#" data-scrollto="#content" data-offset="0" class="dark one-page-arrow"><img class="infinite animated fadeInDown" src="<?php echo get_template_directory_uri( ); ?>/business/images/mouse.svg" alt="Image" ></a>
			</div>
